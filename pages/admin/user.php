            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <?php 
                    include '../../controller/admin/user_control.php';
                    ...
                    <tr>
                      <td class="">
                        <p class="text-sm font-weight-bold mb-0 ms-3"><?= $no++ ?></p>
                      </td>
                      <td>
                      ...
                      <td class="align-middle text-center">
                        <p class="text-sm font-weight-bold mb-0 text-capitalize"><?= $row['role'] ?></p>
                      </td>
                      <td class="align-middle text-center">
                        <a href="../../controller/admin/user_control.php?id=<?= $row['id'] ?>?action=edit" class="text-secondary font-weight-bold text-xs">
                          <i class="fas fa-edit"></i>
                        </a>
                        <a href="../../controller/admin/user_control.php?id=<?= $row['id'] ?>?action=delete" class="text-secondary font-weight-bold text-xs">
