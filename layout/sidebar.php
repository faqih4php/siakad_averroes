    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
       ...
       <?php }elseif($_SESSION['role'] == 2) { ?>
        <li class="nav-item">
          <a class="nav-link <?= $page == 'index' ? 'active' : ''?>" href="<?php echo '/akad_averroes/pages/guru/index.php'; ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa fa-home <?= $page == 'index' ? 'text-white' : 'text-dark'?>"></i>
            </div>
            <span class="nav-link-text ms-1">Dashboard</span>
        ...
        <li class="nav-item">
          <a class="nav-link  <?= $page == 'mapel' ? 'active' : ''?> " href="<?php echo '/akad_averroes/pages/guru/mapel/mapel.php'; ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fa fa-book <?= $page == 'mapel' ? 'text-white' : 'text-dark'?>"></i>
            </div>
            <span class="nav-link-text ms-1">Mata Pelajaran</span>
        ...
        <li class="nav-item">
          <a class="nav-link <?= $page == 'jadwal' ? 'active' : ''?> " href="<?php echo '/akad_averroes/pages/guru/jadwal/jadwal.php'; ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link <?= $page == 'nilai' ? 'active' : ''?> " href="<?php echo '/akad_averroes/pages/guru/nilai/nilai.php'; ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item">
            <a class="nav-link <?= $page == 'raport' ? 'active' : ''?> " href="<?php echo '/akad_averroes/pages/guru/raport/raport.php'; ?>">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
