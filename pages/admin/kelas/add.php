<!-- modal add -->
<div class="modal fade" id="addkelas" tabindex="-1" role="dialog" aria-labelledby="modal-add" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">     
      ...
      <div class="modal-body
        ">
            <form action="../../../controller/admin/kelas_control.php?action=add" method="POST">
